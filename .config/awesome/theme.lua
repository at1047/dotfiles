...
---- Widget glyph font
--theme.wifi_font   = "Hack Nerd Font Mono 12"
----------------------------------
---- 🧠 Wi-Fi glyphs (Nerd Font)
----------------------------------
---- From Material Design Icons (included in Nerd Fonts)
--theme.wifidisc  = "󰤮"  -- Disconnected
--theme.wifinone  = "󰤯"  -- 0–5%
--theme.wifilow   = "󰤟"  -- ~25%
--theme.wifimed   = "󰤢"  -- ~50%
--theme.wifihigh  = "󰤥"  -- ~75%
--theme.wififull  = "󰤨"  -- 100%
...
-- theme.tasklist_fg_focus = "#f5e0dc"
-- 
-- --------------------------------
-- -- 🍔 Menu
-- --------------------------------
...
-- -- 🌄 Wallpaper (optional)
-- --------------------------------
-- theme.wallpaper = gears.filesystem.get_configuration_dir() .. "wallpapers/default.jpg"
-- 
-- --------------------------------
-- -- 📦 Icon theme (optional)
-- --------------------------------
...
-- theme.border_width  = 2
-- 
-- -- Border color for normal (unfocused) windows
-- theme.border_normal = "#585b70"
-- 
-- -- Border color for the focused window
-- theme.border_focus  = "#89b4fa"
-- 
-- -- Optional: border color for "marked" windows (like urgent or special)
-- theme.border_marked = "#f38ba8"
-- 
-- return theme
-- 
